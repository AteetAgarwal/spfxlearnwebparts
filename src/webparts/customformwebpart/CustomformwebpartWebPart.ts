...
export default class CustomformwebpartWebPart extends BaseClientSideWebPart<ICustomformwebpartWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<ICustomformwebpartProps> = React.createElement(
      Customformwebpart,
      {
